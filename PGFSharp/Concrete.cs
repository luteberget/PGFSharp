...
namespace PGF
{
    ...
    public class Concrete
    {
        ...
        public IEnumerable<string> LinearizeAll(Expression e)
        {
            ...
            if (exn.IsRaised || cts == IntPtr.Zero) throw new PGF.Exceptions.PGFException("Could not linearize the abstract tree.");
        ...
        private string LinearizeCnc(IntPtr cnc)
        {
            ...
            if (exn.IsRaised) throw new PGF.Exceptions.PGFException("Could not linearize abstract tree.");
